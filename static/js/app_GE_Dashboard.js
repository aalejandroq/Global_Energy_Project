...
function buildGauge(level, gauge, title) {
  ...
  },
  {
    ...
    textposition: 'inside',
    marker: {
      colors: ['rgba(102, 208, 133, .5)', 'rgba(117, 217, 103, .5)',
        'rgba(142, 221, 103, .5)', 'rgba(169, 225, 103, .5)', 'rgba(198, 230, 103, .5)',
        'rgba(238, 216, 103, .5)', 'rgba(242, 190, 103, .5)',
        'rgba(247, 163, 103, .5)', 'rgba(251, 133, 102, .5)', 'rgba(255, 102, 102, .5)',
        'rgba(255, 255, 255, 0)']
    },
